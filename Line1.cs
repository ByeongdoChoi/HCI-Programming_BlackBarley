...
public class Line1 : MonoBehaviour
{
    ...
    Vector3 line1Pos, line2Pos; // 라인 1과 라인 2 생성

    private void Start()
    {
        lr = GetComponent<LineRenderer>();
        lr.startWidth = 3.0f;   //시작지점 너비
        lr.endWidth = 3.0f;     //끝지점 너비
    ...
    void Update()
    {
        ...
        lr.SetPosition(1, GameObject.Find("line2").GetComponent<Transform>().position); //line2찾아 라인 연결
    }
}
