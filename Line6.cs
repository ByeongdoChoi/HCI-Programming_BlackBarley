...
public class Line6 : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        line6Pos = gameObject.GetComponent<Transform>().position;
    }

    void Update()   //전 라인과 line7을 연결
    {
        lr.SetPosition(0, line6Pos);    
        lr.SetPosition(1, GameObject.Find("line7").GetComponent<Transform>().position);
    }
}
